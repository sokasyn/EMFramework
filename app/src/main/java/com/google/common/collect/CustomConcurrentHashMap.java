 ...
 * {@link Builder#buildComputingMap(ComputingStrategy, Function)}
 * ).
 * <p>
 ...
 * of the <i>optional</i> methods of the {@link Map} and
 * {@link Iterator} interfaces. Partially reclaimed entries are never
 ...
 * </pre>
 * 
 * To create a {@link ConcurrentMap} using the strategy
 * above:
 * 
 * <pre>
 * &#064;code
...
final class CustomConcurrentHashMap {
    ...
    static final class Builder {
         ...
         * besides {@link Map#get} return immediately as if an entry
     ...
     * 
     * @see Builder#buildComputingMap(ComputingStrategy,
     *      Function)
     */
